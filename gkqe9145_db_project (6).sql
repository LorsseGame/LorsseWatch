...
INSERT INTO `anime` (`Code_anime`, `Titre_anime`, `Nombre_episode`, `image`, `image_home`, `nombre_saison`, `image_fond`, `image_titre`, `Code_categorie`) VALUES
(1, 'Kage no Jitsuryokusha ni Naritakute', 14, 'image_anime/Kage_no_Jitsuryokusha_ni_Naritakute/Kage_no_jitsuryokusha_ni_Naritakute.jpeg', 'image_anime/Kage_no_Jitsuryokusha_ni_Naritakute/The-eminence-shadow.jpg', 1, NULL, NULL, 1),
(2, 'Angel of Death', 16, 'image_anime/Angel_of_Death/angel_of_the_death.jpeg', 'image_anime/Angel_of_Death/angel_of_the_death.jpeg', 1, NULL, NULL, NULL),
(3, 'Arifureta', 26, 'image_anime/Arifureta/arifureta.jpeg', 'image_anime/Arifureta/arifureta.jpeg', 2, NULL, NULL, NULL),
(4, 'My Hero Academia', 113, 'image_anime/My_Hero_Academia/my_hero_academia_s6.jpeg', 'image_anime/My_Hero_Academia/my_hero_academia_s6.jpeg', 6, 'image_anime/My_Hero_Academia/mha_fond.png', 'image_anime/My_Hero_Academia/titre_mha.png', 1),
(5, 'Jujutsu Kaisen', 24, './image_anime/Jujutsu_Kaisen/Jujutsu_Kaisen.jpeg', './image_anime/Jujutsu_Kaisen/Jujutsu_Kaisen.jpeg', 1, NULL, NULL, NULL),
(6, 'Blue Lock', 24, './image_anime/Blue_Lock/Blue_Lock.jpeg', './image_anime/Blue_Lock/Blue_Lock.jpeg', 1, './image_anime/Blue_Lock/blue_lock_fond.png', './image_anime/Blue_Lock/titre_blue_lock.png', NULL),
(7, 'RWBY', 10, './image_anime/RWBY/rwby.jpeg', './image_anime/RWBY/rwby.jpeg', 1, NULL, NULL, NULL),
(8, 'Love is War', 24, './image_anime/Love_is_War/love_is_war.png', './image_anime/Love_is_War/love_is_war.png', 2, NULL, NULL, NULL),
(9, 'demon slayer', 46, './image_anime/demon_slayer/Demon_slayer.png', './image_anime/demon_slayer/Demon_slayer.png', 3, NULL, NULL, NULL),
(10, 'Aharen-san', 12, './image_anime/Aharen-san/Aharen-san.jpe', './image_anime/Aharen-san/Aharen-san.jpe', 1, NULL, NULL, NULL),
(11, 'Chainsaw Man', 12, './image_anime/Chainsaw_Man/Chainsaw Man.jpg', './image_anime/Chainsaw_Man/Chainsaw Man.jpg', 1, NULL, NULL, NULL),
(12, 'Charlotte', 13, './image_anime/Charlotte/Charlotte.jpeg', './image_anime/Charlotte/Charlotte.jpeg', 1, NULL, NULL, NULL),
(13, 'moi quand je me reincarne en slime', 49, './image_anime/moi_quand_je_me_reincarne_en_slime/moi_quand_je_me_reincarne_en_slime.jpeg', './image_anime/moi_quand_je_me_reincarne_en_slime/moi_quand_je_me_reincarne_en_slime.jpeg', 2, NULL, NULL, NULL),
(14, 'Overlord', 52, './image_anime/Overlord/Overlord.jpe', './image_anime/Overlord/Overlord.jpe', 4, NULL, NULL, NULL),
(15, 'Tomodachi Game', 12, './image_anime/Tomodachi_Game/Tomodachi_Game.jpeg', './image_anime/Tomodachi_Game/Tomodachi_Game.jpeg', 1, NULL, NULL, NULL),
(16, 'Oshi no Ko', 11, './image_anime/Oshi_no_Ko/oshi no ko.png', './image_anime/Oshi_no_Ko/oshi no ko.png', 1, NULL, NULL, NULL);
...
(3, 'NICOLAS', 'MAGUET', 'LorsseGame', 'lorssegame@gmail.com', '$2y$10$8LH8xjuHQApGxw5YMXt0WOg3Ycd0Qxg4oudWBPfuptRa1CRy52K6K', NULL, './uploads/my_hero_academia_s6.jpeg', 1, 0),
...
--
ALTER TABLE `anime`
  MODIFY `Code_anime` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `episode`
  MODIFY `Code_episode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1315;
...
--
ALTER TABLE `episode`
  ADD CONSTRAINT `EPISODE_Anime0_FK` FOREIGN KEY (`Code_anime`) REFERENCES `anime` (`Code_anime`);
